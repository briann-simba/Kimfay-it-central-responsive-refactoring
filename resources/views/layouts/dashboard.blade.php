...
<div class="flex min-h-screen container mx-auto mt-10">
  <!-- Sidebar -->
<aside id="sidebar"
  class="fixed top-0 left-5 z-40 w-64 h-screen transition-transform -translate-x-full md:translate-x-0 bg-gray-100 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700"
  aria-label="Sidebar">
