...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <!-- Sidebar -->
<aside class="fixed top-0 left-0 h-screen w-64 bg-gray-100 border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-y-auto z-50">
