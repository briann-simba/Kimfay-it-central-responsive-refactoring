<div class="p-6 space-y-6 bg-white dark:bg-gray-900 rounded-2xl shadow-md ring-1 ring-gray-200 dark:ring-gray-700">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                @forelse ($devices as $device)
                    <tr class="bg-white dark:bg-gray-900 hover:bg-indigo-50 dark:hover:bg-gray-800 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right font-semibold">${{ number_format($device->value, 2) }}</td>
